...
export const userActivity = mysqlTable(
  ...
  (table) => [
    ...
    index("user_activity_type_created_idx").on(
      table.activityType,
      table.createdAt
    ),
    // Composite index for target activity tracking
    index("user_activity_target_type_id_idx").on(
      table.targetType,
      table.targetId
    ),
  ]
...
export const userPreferences = mysqlTable(
  ...
  (table) => [
    ...
    index("user_preferences_email_notifications_idx").on(
      table.emailNotifications
    ),
    // Index for in-app notification preferences
    index("user_preferences_in_app_notifications_idx").on(
